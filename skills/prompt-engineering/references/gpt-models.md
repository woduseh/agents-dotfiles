...
Baseline: GPT-6 Astra. Verified 2026-09-05 against [OpenAI's Astra prompting guidance](https://developers.openai.com/api/docs/guides/latest-model?model=gpt-6-astra#prompting-best-practices). This is a reference for the named model, not an instruction to change model or runtime settings.
