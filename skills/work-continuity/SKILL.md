...
description: "Resumes work from notes and prepares handoffs or progress records for work spanning sessions. Use for requested records or meaningful continuity needs, not merely because a task is large."
---

# Work Continuity

Make the next session able to continue without repeating discovery.

On resumption, reconcile the latest request and notes with the current files and runtime state. Continue the task from that verified state.
